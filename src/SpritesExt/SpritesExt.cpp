...
void SpritesExt::drawExternalMask(int16_t x, int16_t y, const uint8_t *bitmap,
                               const uint8_t *mask, uint8_t frame, uint8_t mask_frame, bool flipHoriz)
{
  draw(x, y, bitmap, frame, mask, mask_frame, SPRITE_MASKED, flipHoriz);
}

void SpritesExt::drawOverwrite(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame, bool flipHoriz)
{
  draw(x, y, bitmap, frame, NULL, 0, SPRITE_OVERWRITE, flipHoriz);
}

void SpritesExt::drawErase(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame, bool flipHoriz)
{
  draw(x, y, bitmap, frame, NULL, 0, SPRITE_IS_MASK_ERASE, flipHoriz);
}

void SpritesExt::drawSelfMasked(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame, bool flipHoriz)
{
  draw(x, y, bitmap, frame, NULL, 0, SPRITE_IS_MASK, flipHoriz);
}

void SpritesExt::drawPlusMask(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame)
{
  draw(x, y, bitmap, frame, NULL, 0, SPRITE_PLUS_MASK, false);
}
...
void SpritesExt::draw(int16_t x, int16_t y,
                   ...
                   uint8_t drawMode, bool flipHoriz)
{
  ...
  drawBitmap(x, y, bitmap, mask, width, height, drawMode, flipHoriz);
}

void SpritesExt::drawBitmap(int16_t x, int16_t y,
                         const uint8_t *bitmap, const uint8_t *mask,
                         uint8_t w, uint8_t h, uint8_t draw_mode, bool flipHoriz)
{
    ...
    case SPRITE_UNMASKED:
      ...
      for (uint8_t a = 0; a < loop_h; a++) {
        ...
        if (!flipHoriz) {
          ...
          bofs += w + w + (rendered_width < w ? 0 : w) - rendered_width;
        }
